...
Edit source files in `source/`. The provider-specific distributions in `dist/` are generated by the build scripts, not hand-edited. The public-facing marketing site lives in a separate repository.
