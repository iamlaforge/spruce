...
export function InstallPaginated() {
  ...
  return (
    <Section id="install" tone="default">
      ...
      {/* After installing intro */}
      <div className="grid grid-cols-12 gap-x-6 md:gap-x-8 mb-8 md:mb-10">
        <div className="col-span-12 md:col-span-10 md:col-start-2 lg:col-span-8 lg:col-start-2">
      ...
      {/* Pagination control — clickable numbered tabs, hairline beneath active */}
      <div className="grid grid-cols-12 gap-x-6 md:gap-x-8 mb-8 md:mb-10">
        <div className="col-span-12 md:col-span-10 md:col-start-2 lg:col-span-10 lg:col-start-2">
          <div
            role="tablist"
            aria-label="Pattern examples"
            className="flex items-center gap-6 md:gap-10 border-b border-rule-subtle"
          >
            {patterns.map((p, i) => {
              ...
              return (
                <button
                  ...
                  onClick={() => setActive(i)}
                  className={`flex items-center gap-3 pb-4 -mb-px border-b-2 transition-colors duration-fast ease-considered ${
                    isActive
                      ? "border-accent text-ink"
                      : "border-transparent text-ink-subtle hover:text-ink-muted"
                  }`}
                >
                  <span className={`font-mono text-2xs uppercase tracking-widest ${isActive ? "text-accent" : "text-ink-subtle"}`}>
                    0{i + 1}
                  </span>
      ...
      {/* Active pattern */}
      <div className="grid grid-cols-12 gap-x-6 md:gap-x-8 items-start mb-16 md:mb-20">
        <div className="col-span-12 md:col-span-10 md:col-start-2 lg:col-span-5 lg:col-start-2">
          <h3 className="font-display font-normal text-xl md:text-2xl leading-tight tracking-tight text-ink text-balance">
            {pattern.heading}
          </h3>
        ...
        <div className="col-span-12 md:col-span-10 md:col-start-2 lg:col-span-5 lg:col-start-8 mt-6 lg:mt-0">
          <div className="bg-surface border border-rule-subtle rounded-md px-5 py-4 md:px-6 md:py-5 font-mono text-base md:text-lg leading-snug">
            <span className="text-accent select-none mr-3" aria-hidden>&rsaquo;</span>
