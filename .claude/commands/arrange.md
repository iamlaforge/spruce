---
name: arrange
description: Apply spatial design discipline to an existing interface. Addresses spacing rhythm, proximity relationships, hierarchy through space, vertical meter, and negative space. Makes small spacing corrections autonomously; surfaces scale establishment and density shifts for user approval. Flags layout restructuring issues but defers structural changes to /refine or /design. Accepts optional scope arguments to focus on specific spatial concerns.
user-invocable: true
---
